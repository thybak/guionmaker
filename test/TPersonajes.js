...
var nombreEntidad = "personaje";
var nombreEntidadPlural = nombreEntidad + 's';
describe('Personajes', function () {
    /*
    ...
    */
    ...
    describe('/POST ' + nombreEntidad, function () {
        ...
        it('debe devolver un error al no asignar un proyecto a la entidad', function (done) {
            var entidad = {
                nombre: "prueba",
                edad: 20,
                procedencia: "una prueba más"
            };
