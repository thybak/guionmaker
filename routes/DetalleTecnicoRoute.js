...
(function (Route) {
    class DetalleTecnicoRoute {
        ...
        getDetallesTecnicos(req, res, next) {
            APIHelper_1.APIHelper.getAll(DetalleTecnicoRoute.model, res);
        }
        ...
        getDetalleTecnicoById(req, res, next) {
            APIHelper_1.APIHelper.getById(DetalleTecnicoRoute.model, req.params.id, res);
        }
        deleteDetalleTecnico(req, res, next) {
            APIHelper_1.APIHelper.delete(DetalleTecnicoRoute.model, req.params.id, res);
        }
    }
